...
namespace SqlStudio
{
	partial class DatabaseConnectionUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			toolStripDatabaseConnectionsDropDownButton.ImageTransparentColor = Color.Magenta;
			toolStripDatabaseConnectionsDropDownButton.Name = "toolStripDatabaseConnectionsDropDownButton";
			toolStripDatabaseConnectionsDropDownButton.Size = new Size(73, 22);
			...
			tabPage1.Font = new Font("Microsoft Sans Serif", 9F, FontStyle.Regular, GraphicsUnit.Point);
			...
			cmdLineControl.Font = new Font("Microsoft Sans Serif", 12F, FontStyle.Regular, GraphicsUnit.Point);
			...
			cmScriptTabs.Size = new Size(185, 142);
			// 
			...
			runToolStripMenuItem.Size = new Size(184, 26);
