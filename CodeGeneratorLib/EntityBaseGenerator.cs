...
{
    public class EntityBaseGenerator
    {
        ...
        public void AddColumn(string name, string type, string fieldName, bool isKey, int dataLength)
        {
            ...
            ArrayInst arrayInst = _input.AddArrayInst("real_columns");
        ...
        public string Generate()
        {
            ...
            TextReader reader = new StreamReader(assembly.GetManifestResourceStream("CodeGeneratorLib.EntityBaseGenerator.txt"));
