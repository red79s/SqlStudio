...
{
    public class ColumnCacheDataRow : ColumnCacheDataRowBase
    {
        public ColumnCacheDataRow(DataRowBuilder dataRowBuilder) : base(dataRowBuilder)
        {
        }
    }
}